...
final class SecurityMessageKey
{
    ...
    public const CAPTCHA_PROVIDER_RUNTIME_FAILED = 'message.captcha.provider_runtime_failed';
    public const CAPTCHA_PROVIDER_RESULT_INVALID = 'message.captcha.provider_result_invalid';
