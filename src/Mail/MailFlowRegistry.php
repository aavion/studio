...
final readonly class MailFlowRegistry
{
    ...
    private function definitionMap(): array
    {
        ...
        return [
            ...
            AccountMailFlow::AccountClosed->value => new MailFlowDefinition(AccountMailFlow::AccountClosed, AccountMailFlow::AccountClosed->value, $group, 'admin.mail_templates.flows.account_closed', ['email', 'username', 'user_uid', 'retention_days']),
            AccountMailFlow::AccountRestored->value => new MailFlowDefinition(AccountMailFlow::AccountRestored, AccountMailFlow::AccountRestored->value, $group, 'admin.mail_templates.flows.account_restored', ['email', 'username', 'user_uid']),
        ];
    }
}
