...
final readonly class PackageSchedulerDefinitionCallScanner
{
    public function __construct(
        private PackageSchedulerDefinitionImportResolver $importResolver = new PackageSchedulerDefinitionImportResolver(),
    ) {
    }
