...
use App\Core\Package\Install\PackageZipVerifyAction;
use App\Core\Workflow\WorkflowResult;

final readonly class PackageInstallVerifyLiveOperationProvider implements LiveOperationQueueProviderInterface
{
    ...
    {
        return LiveOperationQueueFactory::PACKAGE_INSTALL_VERIFY;
    }
    ...
    public function create(array $payload = []): WorkflowResult
    {
        ...
        return WorkflowResult::success(ActionQueue::create('package install verification', [
            new PackageZipVerifyAction($this->installer, $payload),
        ], context: [
            'operation' => $this->operation(),
