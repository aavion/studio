...
final readonly class ExtensionSourceNamespaceValidator
{
    ...
    {
        $expectedNamespace = trim((string) ($candidate->manifest()->get('EXTENSION_NAMESPACE') ?? ''));
        ...
        if (!$this->isValidPhpNamespace($expectedNamespace)) {
            return [$this->invalidNamespaceIssue($candidate, 'EXTENSION_NAMESPACE', 'EXTENSION_NAMESPACE', $expectedNamespace, $expectedNamespace)];
        }
        ...
        foreach ($files as $file) {
            ...
            if (!$this->isExtensionNamespace($namespace, $expectedNamespace)) {
    ...
    private function isExtensionNamespace(?string $namespace, string $expectedNamespace): bool
    {
    ...
    private function invalidNamespaceIssue(
        ...
        return Message::create(
            ExtensionMessageCode::EXTENSION_PHP_NAMESPACE_INVALID,
            ExtensionMessageKey::EXTENSION_PHP_NAMESPACE_INVALID,
