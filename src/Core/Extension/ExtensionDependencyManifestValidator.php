...
final readonly class ExtensionDependencyManifestValidator
{
     ...
     */
    private function issue(ExtensionCandidate $candidate, string $reason, array $context): Message
    {
        return Message::create(
            ExtensionMessageCode::EXTENSION_POLICY_BLOCKED_PATH,
            ExtensionMessageKey::EXTENSION_POLICY_BLOCKED_PATH,
            ...
            context: [
                ...
                'path' => 'composer.json',
                'reason' => $reason,
                'policy' => 'extension.dependency_manifest',
                ...$context,
            ],
