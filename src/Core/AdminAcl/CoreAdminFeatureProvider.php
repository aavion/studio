    ...
    public function adminFeatures(): array
    {
        return [
            ...
            new AdminFeatureDefinition(
                ...
                'admin.acl.features.admin_settings_packages.label',
                'admin.acl.features.admin_settings_packages.description',
                'admin.acl.categories.settings',
                sortOrder: 70,
            ),
            new AdminFeatureDefinition(
            ...
            new AdminFeatureDefinition(
                'admin.packages',
                'admin.acl.features.admin_packages.label',
                'admin.acl.features.admin_packages.description',
                'admin.acl.categories.packages',
                sortOrder: 110,
            ),
            new AdminFeatureDefinition(
                'admin.packages.self_update',
                'admin.acl.features.admin_packages_self_update.label',
                'admin.acl.features.admin_packages_self_update.description',
                'admin.acl.categories.packages',
                configurable: false,
                sortOrder: 120,
            ),
