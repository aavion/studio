...
final class EventMessageKey
{
    ...
    public const EVENT_HOOK_EXTENSION_ASSET_SYNC_STARTED_SUMMARY = 'message.event.hook.extension_asset_sync_started.summary';
    public const EVENT_HOOK_EXTENSION_ASSET_REGISTRY_BUILD_SUMMARY = 'message.event.hook.extension_asset_registry_build.summary';
    public const EVENT_HOOK_EXTENSION_ASSET_SYNC_COMPLETED_SUMMARY = 'message.event.hook.extension_asset_sync_completed.summary';
}
