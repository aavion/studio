...
final readonly class UserNavigationSubscriber implements EventSubscriberInterface
{
    ...
    public function onNavigationBuilder(NavigationBuilderEvent $event): void
    {
        ...
        $this->addChild($event, 'invitations', 'ui.user.invitations.title', 'user_invitations', 30, ['min_access_level' => AccessLevel::REGISTERED]);
        ...
        $this->addChild($event, 'logout', 'ui.user.logout.title', 'user_logout', 1000, ['min_access_level' => AccessLevel::REGISTERED]);
    }
