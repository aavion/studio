...
final class SystemThemeMetadataProvider
{
    ...
    /**
     * @return array{identifier: string, name: string, immutable: bool, public_fallback: bool, version: string|null, date: string|null, channel: string|null, source: string|null, manifest: array<string, string>}
     */
