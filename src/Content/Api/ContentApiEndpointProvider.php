...
final readonly class ContentApiEndpointProvider implements ApiEndpointProviderInterface
{
    ...
    private const TAGS = ['frontend-content', 'frontend-content-items'];
    private const ITEM_PATTERN = '[a-z0-9]+(?:-[a-z0-9]+)*(?:/items/[a-z0-9]+(?:-[a-z0-9]+)*)*';

    public function apiEndpoints(): array
    {
        return [
            new ApiEndpointDefinition('content', Request::METHOD_GET, '/api/v1/content', 'api_v1_endpoint_dispatch', 'listContentApiEndpoints', 'List content API children.', self::HANDLER_CONTENT_INDEX, self::TAGS, allowPublic: true),
            new ApiEndpointDefinition('content', Request::METHOD_GET, '/api/v1/content/items', 'api_v1_endpoint_dispatch', 'listPublishedContentItems', 'List public published content item metadata.', self::HANDLER_CONTENT_ITEMS, self::TAGS, parameters: $this->collectionParameters(), responseSchema: ['type' => 'object'], allowPublic: true),
