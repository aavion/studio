...
final class TestDatabaseMenuSeeder
{
    public static function seed(TestDatabaseSeedWriter $writer): void
    {
        $writer->insert('site_menu', [
            'uid' => '30000000-0000-7000-8000-000000000001',
            'identifier' => 'main',
        ...
        foreach ([
            ['30000000-0000-7000-8000-000000000101', 10, ['en' => 'Home', 'de' => 'Start'], '/'],
            ['30000000-0000-7000-8000-000000000102', 20, ['en' => 'About', 'de' => 'Ueber'], '/about'],
            ['30000000-0000-7000-8000-000000000103', 30, ['en' => 'News', 'de' => 'News'], '/news/first-update'],
