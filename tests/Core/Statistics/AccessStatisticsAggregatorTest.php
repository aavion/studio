...
final class AccessStatisticsAggregatorTest extends TestCase
{
    ...
    public function testItAggregatesAccessLogsWithoutExposingIps(): void
    {
        $this->writeTestFile($this->logDir, 'test.studio-access-2026-05-27.log', implode(PHP_EOL, [
            '[2026-05-27T10:00:00.000000+00:00] studio_access.INFO: access.request {"method":"GET","path":"/","route":"content_home","http_status":200,"ip":"203.0.113.10","user_agent":"Studio Browser/1.0","country":"DE"} []',
            '[2026-05-27T10:01:00.000000+00:00] studio_access.INFO: access.request {"method":"GET","path":"/missing","route":"content_view","http_status":404,"ip":"203.0.113.10","user_agent":"Studio Browser/1.0","country":"DE"} []',
            '[2026-05-27T10:02:00.000000+00:00] studio_access.INFO: access.request {"method":"POST","path":"/admin","route":"backend_admin_index","http_status":302,"ip":"203.0.113.12","proxy_client_ip":"198.51.100.42","user_agent":"Other Browser/2.0","country":"n/a"} []',
            '',
        ]));
        ...
        self::assertStringNotContainsString('198.51.100', $encoded);
        self::assertStringNotContainsString('Studio Browser', $encoded);
    }
}
