...
final class MessageKeyTest extends TestCase
{
    ...
    private static function namePrefixes(): array
    {
        return [
            ...
            SecurityMessageKey::class => ['ACL_', 'USER_', 'ACCOUNT_', 'API_KEY_', 'RATE_LIMIT_', 'CAPTCHA_', 'AUTO_BAN_'],
    ...
    private static function valuePrefixes(): array
    {
        return [
            ...
            SecurityMessageKey::class => ['message.acl.', 'message.user.', 'message.account_', 'message.api_key.', 'message.rate_limit.', 'message.captcha.', 'message.auto_ban.'],
