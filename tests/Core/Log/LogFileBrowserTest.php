...
final class LogFileBrowserTest extends TestCase
{
    ...
    {
        $this->writeTestFile($this->logDir, 'test.system-message-2099-01-01.log', implode(PHP_EOL, [
            '[2099-01-01T10:00:00.000000+00:00] system_message.INFO: message.package.discovery_completed {"code":"package.discovery_completed"} []',
            '[2099-01-01T10:01:00.000000+00:00] system_message.ERROR: message.process.command_failed {"code":"process.command_failed","package":"demo-module"} []',
            '',
        ]));
        ...
        self::assertSame('test.system-message-2099-01-01.log', $view['entries'][0]['file']);
    ...
    {
        $this->writeTestFile($this->logDir, 'test.system-access-2099-01-01.log', '[2099-01-01T10:00:00.000000+00:00] system_access.INFO: access.request {"method":"GET","path":"/admin/logs","route":"backend_admin_route","http_status":200,"ip":"127.0.0.1","city":"n/a","state":"n/a","country":"n/a","continent":"n/a"} []'.PHP_EOL);
