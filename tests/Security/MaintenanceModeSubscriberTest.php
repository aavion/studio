...
final class MaintenanceModeSubscriberTest extends TestCase
{
    ...
    public function testItAllowsOperationalBypassPathsDuringMaintenanceMode(): void
    {
        ...
        foreach (['/admin', '/admin/content', '/user/login', '/de/user/login', '/cron/run', '/api/v1/status', '/api/live/operations/aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', '/assets/app.css', '/build/app.js'] as $path) {
