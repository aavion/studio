...
> **Updated**: 2026-05-20  
> **Owner**: Core  
> **Purpose:** Entrypoint for developer documentation on how to extend and maintain aavion.studio.

This manual is a draft while the CMS core is still being implemented. It should collect practical references for contributors, theme developers, module developers, and maintainers.
