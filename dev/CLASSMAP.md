...
| N/A | `App\Content\Routing\ContentRouteLocalization` | Resolves localized public content route prefixes, browser-language/default redirects, configured home paths, and translation-derived reserved language prefixes. | `dev/draft/0.1.x-StaticDynamicContent.md` | `tests/Controller/PublicContentControllerTest.php` |
| N/A | `App\Content\Routing\LocalizedContentRoute` | Value object for localized content route resolution, carrying the content path, language, and optional redirect path. | `dev/draft/0.1.x-StaticDynamicContent.md` | `tests/Controller/PublicContentControllerTest.php` |
...
| N/A | `App\Content\Routing\ContentRoutePath` | Value object for normalized content paths with optional trailing generic variant marker extraction. | `dev/draft/0.1.x-StaticDynamicContent.md` | `tests/Content/Read/PublishedContentResolverTest.php`, `tests/Controller/PublicContentControllerTest.php` |
...
| N/A | `App\Content\Routing\ContentSystemRoute` | Defines the internal-only `/system/...` content namespace and virtual parent marker. | `dev/draft/0.1.x-StaticDynamicContent.md` | `tests/Entity/ContentItemTest.php`, `tests/Content/Read/PublishedContentResolverTest.php` |
