...
- Allowed `/api/live/*` during pre-completion setup so JSON polling is not redirected, and added setup rollback cleanup for generated env files plus SQLite setup databases under `var/` when setup fails.
