...
### 2026-05-28
- Hardened Admin User and ACL-group management: added access hierarchy/self-lockout/last-admin guardrails, required ACL group impact review before updates or deletes, cleaned deleted group identifiers from users, account tokens, content items, schema versions, and site menu items, and expanded audit contexts with before/after values.
