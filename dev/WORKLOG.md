...
- Hardened backend controller redirect-follow assertions with an admin-aware test helper so Windows compatibility runners keep their synthetic admin session across mutating package, settings, and scheduler POST redirects.
