...
- [ ] Audit follow-up: harden APP_SECRET rotation emergency handling with idempotent server-side state before production readiness.
...
- [ ] Audit follow-up: add package selector/CSS namespace validation and decide whether optional branding packages need capabilities beyond `system-template`.
