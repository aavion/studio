...
- Hardened late scheduler review edges around exact cron-call parsing, unrelated scheduler-definition class names, in-call comment handling, web-triggered PHP invocation, package ActionQueue confirmation resets including target changes, and Composer preflight recovery.
