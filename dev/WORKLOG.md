...
- Hardened late scheduler review edges around exact cron-call parsing, unrelated scheduler-definition class names, web-triggered PHP invocation, package ActionQueue confirmation resets, and Composer preflight recovery.
