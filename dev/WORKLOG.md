...
- Hardened logout routing so `GET /user/logout` renders a translated confirmation page while only a CSRF-protected `POST /user/logout` can terminate the session.
