...
### 2026-05-28
- Tightened usernames to 5-30 ASCII letters, digits, hyphens, or underscores starting with a letter, added the default-off `user.username_change.enabled` setting for self-service profile username changes, updated validation text, and localized the deleted-user identity fallback.
