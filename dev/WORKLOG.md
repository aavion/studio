...
- Updated the live-operation overlay controller so the triggering submit button is disabled while a background operation runs, then remapped to the overlay OK action on success or a color-coded details opener for review, warning, and failure states.
