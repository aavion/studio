...
- Hardened the review baseline against traversal, symlink, and status-downgrade risks by validating package source paths, skipping symlinks in discovery and inventories, rejecting symlink package copy sources, blocking filesystem actions from reading or writing through symlink sources or targets, and preserving failed or blocked queue status when continuing after action errors.
