...
- Hardened review-reported access/statistics edges: visitor IDs and GeoIP now use Symfony's trusted client IP, statistics aggregate across the full selected window before top-list limits, access query strings redact sensitive parameters, and access/statistics telemetry failures cannot break completed responses.
