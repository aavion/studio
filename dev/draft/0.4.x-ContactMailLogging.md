...
- Keep rotating filesystem logs as the durable raw operational source with a 30-day default retention, but evaluate a parallel database-backed security event projection for query-heavy Security features.
