...
- Reserve route prefixes for system areas such as `admin/`, `editor/`, `setup/`, `system/`, `user/`, `api/`, `assets/`, `_profiler/`, `_wdt/`, `build/`, `modules/`, `media/`, and `files/`.
...
- **Decision recorded:** Reserve core prefixes early to avoid future URL conflicts. Initial reserved prefixes include `admin/`, `editor/`, `setup/`, `system/`, `user/`, `api/`, `assets/`, `_profiler/`, `_wdt/`, `build/`, `modules/`, `media/`, and `files/`.
