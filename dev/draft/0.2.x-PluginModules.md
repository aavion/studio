...
- Activation planning runs before mutation. The first pass resolves package dependencies, rejects circular hard dependencies, verifies installed versions/status, and reports which packages would be activated or deactivated. The second pass executes the validated plan.
