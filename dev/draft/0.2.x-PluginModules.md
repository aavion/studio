...
- **Decision recorded:** Package-owned CSS should use a stable `<package>-<surface>-<component>` naming convention. The native system package should follow the same ownership model rather than treating `studio-` as a universal prefix for every component class.
