...
- Trigger `studio:assets:rebuild` after package install, activation, deactivation, update, uninstall, or runtime state exits such as active packages becoming `faulty` or `removed`. Run asset-map compilation only in production.
