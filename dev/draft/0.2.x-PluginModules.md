...
- Aggregate only active package language files into generated `translations/runtime/messages.{locale}.yaml` before cache clearing. Inactive package translations under `packages/` must not be loaded by Symfony.
