...
- **Open:** Decide first allowed MIME types, max upload size, thumbnail strategy, and exact private-media delivery strategy before implementation. Start with generic conservative defaults and adjust later.
