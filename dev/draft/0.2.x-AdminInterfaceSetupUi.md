...
- **Decision recorded:** The first web setup implementation is a single CSRF-protected form that can run the shared `SetupRunner` in dry-run mode for local verification before the later multi-step wizard exists.
