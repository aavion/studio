...
- Template namespace contract:
  - `@frontend/...` maps to `templates/frontend/**` and package `templates/frontend/**` candidates from active packages with `frontend-theme` scope.
  - `@backend/...` maps to `templates/backend/**` and package `templates/backend/**` candidates from active packages with `backend-theme` scope.
