...
- Rate-limit policy remains application-owned; extensions may request classification later but do not define raw Symfony limiter names.
...
- No auto-ban state or enforcement.
